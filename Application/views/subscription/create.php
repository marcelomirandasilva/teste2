...
<div class="container md:w-8/12 mt-5 mb-5">
    ...
    <form action="/event/store" method="POST" class="bg-white p-6 rounded shadow-md">
        <div class="mb-4">
            <label for="no_event" class="block text-gray-700">Nome</label>
            <input type="text" name="no_event" id="no_event" class="border border-gray-300 p-2 w-full" required>
        </div>
